return {
    ...
    keys = {
        ...
        {
            '<C-b>',
            function() require('neoscroll').ctrl_b { duration = 100 } end,
            mode = { 'n', 'v', 'x' },
        },
        {
            '<C-f>',
            function() require('neoscroll').ctrl_f { duration = 100 } end,
            mode = { 'n', 'v', 'x' },
        },
        {
            '<C-y>',
        ...
        {
            'zt',
            function() require('neoscroll').zt { half_win_duration = 150 } end,
            mode = { 'n', 'v', 'x' },
        },
        {
            'zz',
            function() require('neoscroll').zz { half_win_duration = 150 } end,
            mode = { 'n', 'v', 'x' },
        },
        {
            'zb',
            function() require('neoscroll').zb { half_win_duration = 150 } end,
            mode = { 'n', 'v', 'x' },
        },
    },
    opts = {
